...
public class EditarLibroController {
    ...
    void GuardarCambios(ActionEvent event) {
        ...
        if (txtTituloE.getText().isEmpty() || txtAutorE.getText().isEmpty() ||
            txtISBNE.getText().isEmpty() || txtEditorialE.getText().isEmpty() ||
            cbGeneroE.getValue() == null || cbCategoriaE.getValue() == null ||
            txtAnioE.getText().isEmpty() || txtPrecioE.getText().isEmpty()) {
        ...
        // Cerramos la ventana
        Stage stage = (Stage) txtTituloE.getScene().getWindow();
        stage.close();
    }
